...
//    pose_stamped.pose.position.x = P.z() ;
//    pose_stamped.pose.position.y = -(P.x() + VISUALIZATION_SHIFT_X);
//    pose_stamped.pose.position.z = -(P.y() + VISUALIZATION_SHIFT_Y);
//    pose_stamped.pose.orientation.x = Q.z();
//    pose_stamped.pose.orientation.y = -Q.x();
//    pose_stamped.pose.orientation.z = -Q.y();
//    pose_stamped.pose.orientation.w = Q.w();
